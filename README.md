...
- Oculusに特化したSDKではなく、多様なVR機器に対応できるOpenXR, Unity XR Interaction Toolkitを選定しました。
...
<img src="img/resume/ci-settings.png" width="40%">
...
<img src="img/resume/talk_intention.png">

### 身分証の認証率の向上（47.5% → 54.2%）
...
<img src="img/resume/identification_rate.png">
