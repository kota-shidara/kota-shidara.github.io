...
### 主要な開発
- OpenXRの恩恵により、HTC Vive, Pico, Valve Indexなど多様なVRデバイスに対してアプリをリリース
- Unity内のメタバース空間をUnity as a Libraryとしてモバイルアプリに組み込み、審査を通してリリース [技術調査ログiOS版](https://zenn.dev/flamers/articles/3cd8f4781b4892), [Android版](https://zenn.dev/flamers/articles/aeadd5c721a0d6)
- Appleでサインイン機能の実装 [調査ログ](https://zenn.dev/dara/scraps/e659306593b8e7)
