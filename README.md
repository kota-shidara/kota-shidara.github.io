...
- プロダクションのコードを書いた経験があるもの
  ...
  - Swift（2年）
- そこそこ触ったことがあるもの
  - Python（卒論の機械学習, numpy, pandas, scikit-learn / Flaskでのサーバー構築 / アルゴリズム実装 / ROS 2）
  - Go（プロダクションでWebRTCを用いたサーバーで利用・主にコードレビューとバグFIXを担当）
...
<img src="img/resume/ci-settings.png" width="50%">
...
- 結果、コミュニケーション頻度が増え、より意図の伝達がスムーズになり、エンジニアメンバーがより前向きに企画の実装に向き合えるようになりました。
